...
#    # Captura o momento atual já convertido para o fuso correto
...
#async def main():
#    print("🤖 Iniciando o Agente Organizador do Trello Oficial...")
    #runner = Runner()
    #resposta = await runner.run(root_agent,input="Quais são as minhas tarefas para hoje?")
    #print("\nResposta do Agente:")
    #print(resposta)
    
#if __name__ == "__main__":
    # O ADK exige que o loop assíncrono gerencie a aplicação
#    asyncio.run(main())